...
def init_database():
    ...
    with app.app_context():
        ...
        # insert sample data
        source = CedSource(id='datacite', display_name='DataCite', icon_url='datacite.png')
        event1 = CedEvent(
            id='peeZ2knsGxRzvuw4NVW6',
            doi='10.1039/c5ce01901j',
            api_raw=dict(
                {"id": "80c78ffb-8d32-4de7-8023-1187dffdaef2", "terms": "https://doi.org/10.13003/CED-terms-of-use",
                 "obj_id": "https://doi.org/10.1039/c5ce01901j",
                 "license": "https://creativecommons.org/publicdomain/zero/1.0/",
                 "subj_id": "https://doi.org/10.5517/cc13t0gd", "source_id": "datacite",
                 "timestamp": "2017-06-28T04:23:34Z", "occurred_at": "2014-12-01T14:09:33Z",
                 "source_token": "28276d12-b320-41ba-9272-bb0adc3466ff", "message_action": "create",
        ...
        event2 = CedEvent(
            ...
            doi='10.1039/c5ce01901j',
            api_raw=dict(
                {"id": "4d6a48be-6d51-4d4b-be91-4d5929fa0ba0", "terms": "https://doi.org/10.13003/CED-terms-of-use",
                 "obj_id": "https://doi.org/10.1039/c5ce01901j", "license": "https://creativecommons.org/publicdomain/zero/1.0/",
                 "subj_id": "https://doi.org/10.5517/cc13t0hf", "source_id": "datacite", "timestamp": "2017-06-28T04:23:34Z",
                 "occurred_at": "2014-12-01T14:09:34Z", "source_token": "28276d12-b320-41ba-9272-bb0adc3466ff",
                 "message_action": "create", "relation_type_id": "is_supplement_to"}),
            occurred_at=datetime.strptime('2014-12-01', '%Y-%m-%d'),
